...
if __name__ == "__main__":
    # Create environment
    sac_agent = SAC.load("SAC_Iteration2\sac_prioritized_replay_model_new.zip")
    env = Gym2OpEnv()
    ...
    stats = evaluate_agent(env, sac_agent, num_episodes=100, max_steps=10000)
    ...
    plt.savefig('evaluation_results_SAC_Iteration2.png')
    plt.close()